    ...
    return (
      <div className="app" style={{fontFamily:"HelveticaNeue-Light"}}>
        ...
        <div className="header" style={{display:"flex", backgroundColor:"#42b9f4", justifyContent:"center"}}>
          ...
          <div className="headerWrapper" style={{width:"1100px", paddingLeft:"20px", paddingRight:"20px"}}>
        ...
        <div className="body" style={{display:"flex", justifyContent:"center"}}>
          ...
          <div className="bodyWrapper" style={{width:"1100px", paddingLeft:"20px", paddingRight:"20px"}}>
            <div className="topCard" style={{ borderBottomStyle:"solid", borderBottomWidth:"1px", borderBottomColor:"#CCCCCC", paddingTop:"50px", paddingBottom:"50px"}}>
              ...
              <div className="contentSection" style={{flexBasis:"60%"}}>
                ...
                <p style={{fontFamily:"Quicksand", fontWeight:"700",  color:"#555555", fontSize:"22px"}}>I&#39;m an engineer, entrepreneur, and ping pong enthusiast.</p>
                <p style={{color:"#666666", fontSize:"20px"}}>At a young age I moved from Israel to Silicon Valley for my father&#39;s startup, quickly inheriting the entrepreneurial bug and love for technology.</p>
                <p style={{fontWeight:"300", color:"#666666", fontSize:"20px"}}>I studied Electrical Engineering and Computer Science at UC Berkeley, with a focus in graduating ASAP. On campus, I was involved in the hackathon community as director of the first Cal Hacks, and the Israeli community through my work in Mishelanu.</p>
                <p style={{fontWeight:"300", color:"#666666", fontSize:"20px"}}>I&#39;ve since picked up experience at amazing companies like Illumio, LinkedIn, and Microsoft, and currently spend my days exploring solutions in artificial intelligence.</p>
            ...
            <div className="projects" style={{paddingTop:"50px", paddingBottom:"40px", borderBottomStyle:"solid", borderBottomWidth:"1px", borderBottomColor:"#CCCCCC"}}>
              ...
              <div className="project" style={{marginTop:"10px", marginBottom:"40px"}}>
                <div className="projectContent" style={{flexBasis:"50%"}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400",  color:"#555555", fontSize:"22px"}}>An app for weighing objects on your phone&#39;s screen.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>When apple introduced 3d touch, I wanted to turn my iPhone into a functioning scale. When others&#39; attempts were rejected from the app store, I built a game that could be secretly used to do it.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>After nearly a million video views and over 100,000 downloads in two days, I got a nice call from apple and the app and video had to go. Here is the video quietly re-uploaded!</p>
              ...
              <div className="project" style={{marginTop:"10px", marginBottom:"20px"}}>
                <div classNAme="projectContent" style={{flexBasis:"50%"}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>A keyboard for sending commonly used text snippets.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Whether it’s texting, dating, business, or just regular daily communication, we tend to repeat ourselves quite often.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>With Ditto, save your most commonly used texts, phrases, and templates, and access them easily from any app!</p>
                  <div className="pressLinks">
            ...
            <div className="experience" style={{paddingTop:"50px", paddingBottom:"50px", borderBottomStyle:"solid", borderBottomWidth:"1px", borderBottomColor:"#CCCCCC"}}>
              ...
              <div className="role" style={{marginTop:"20px", marginBottom:"30px"}}>
                ...
                <div className="roleContent" style={{flexBasis:"55%"}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>Software Engineer - distributed systems team</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Worked on many projects, from the core security policy computation engine, to automating our command line interface, to enforcing consistency and versioning of our APIs.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>On the side, I ran Illumio&#39;s university hackathon efforts at Berkeley and Stanford, and organized the company&#39;s first <a style={{textDecoration:"none"}} href="https://www.illumio.com/blog/hackday-2016#gsc.tab=0">internal hackathon.</a></p>
                </div>
              ...
              <div className="role" style={{marginTop:"20px", marginBottom:"30px"}}> 
                <div className="roleContent" style={{}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>Software Engineering Intern</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Built a new transactional notification system for Microsoft&#39;s Commerce platform. Replaced two legacy email systems with a modern, RESTful API developed in C# on the .NET framework, using Azure web services.</p>
                </div>
              </div>
              ...
              <div className="role" style={{marginTop:"20px", marginBottom:"30px"}}> 
                ...
                <div className="roleContent" style={{}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>Software Engineering Intern</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Built the Applicant Analytics feature on the job posting page. This feature gives the viewer a sense of where he or she stands with respect to other applicants via distributions of seniority, education, skillsets, etc.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Written in Scala on the Play framework, using Pinot database for realtime updates.</p>
                </div>
              </div>
              ...
              <div className="role" style={{marginTop:"20px", marginBottom:"30px"}}> 
                ...
                <div className="roleContent" style={{flexBasis:"55%"}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>Founder & Organizer</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>IAC Ofek is a social/professional meetup group for young Israelis in Silicon Valley. Our events range from wine nights with keynote speakers to cooking workshops at the park.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>After college, I wanted to find an Israeli community for people my age but had no luck. IAC Ofek was the solution!</p>
                </div>
              ...
              <div className="role" style={{marginTop:"20px", marginBottom:"30px"}}> 
                ...
                <div className="roleContent" style={{}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>Director - Sponsorship</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Cal Hacks is UC Berkeley’s iconic hackathon. From October 3–5, 2014, nearly 1500 hackers from over 50 schools attended what became the biggest collegiate hackathon of all time.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Spent several months planning the event, focusing on fundraising and sponsor relations.</p>
                </div>
              ...
              <div className="role" style={{marginTop:"20px", marginBottom:"30px"}}> 
                ...
                <div className="roleContent" style={{}}>
                  ...
                  <p style={{fontFamily:"Quicksand", fontWeight:"400", color:"#555555", fontSize:"22px"}}>Founder - Cal Chapter</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Mishelanu is a social group for Israeli college students. Throughout the year, students attend a range of events from hikes and holiday dinners to regional retreats.</p>
                  <p style={{color:"#666666", fontSize:"20px"}}>Mishelanu was born from a need for an Israeli community on campus, which previously did not exist. We started with just 6 campuses, and had to build up our content from scratch. I&#39;m proud to say Mishelanu is now one of the fastest growing Jewish student organizations at over 100 campuses across the US.</p>
